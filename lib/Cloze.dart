...
const Color kSynonymButtonColorUnselected = Color(0xFFA4DEF1);
const Color kSynonymButtonColorSelected = Color(0xFFF6F6F6);
const Color listViewBackgroundColor = Color(0xFF50C0E5);
...
class ClozeScreen extends StatefulWidget {
  @override
  _ClozeScreenState createState() => _ClozeScreenState();
}
            ...
            children: <Widget>[
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    'assets/ClozeScreenContinue.JPG',
                    fit: BoxFit.contain,
                  ),
                ),
              ),
